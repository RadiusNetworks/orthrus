...
% Varying distance(10 to 0 meters), varying angle(-50 to 50 deg)

aoa_data = importdata('sample_data_captures/aoa_maxmin_distance_and_angle.txt',',');
tof_data = importdata('sample_data_captures/tof_maxmin_distance_and_angle.txt',',');
